  ...
  return (
    <div className="flex  flex-col  top-0 z-50">
      <header className="flex gap-1 ">
        ...
        <div className="relative flex items-center justify-center gap-4 p-4 text-sky-800 absolute mx-auto">
          <div className="relative z-10 text-2xl font-extrabold text-sky-800 text-center">
            {title}
          </div>
        </div>
      </header>
